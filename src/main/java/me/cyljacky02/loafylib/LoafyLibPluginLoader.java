 ...
 * 
 * IMPORTANT: This class must be Java, not Kotlin, because it runs before the library loader
...
public class LoafyLibPluginLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder classpathBuilder) {
        ...
        resolver.addRepository(
            new RemoteRepository.Builder("sponge", "default", "https://repo.spongepowered.org/repository/maven-public/")
                .build()
        );
